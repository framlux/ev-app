...
describe('null versus zero', () => {
	...
	const cases: [string, unknown, string][] = [
		...
		['formatKm(0)', formatKm(0), '0.0 km'],
		['formatKm(null)', formatKm(null), DASH],
		...
		['formatTempC(0)', formatTempC(0), '0°C'],
		['formatTempC(-3)', formatTempC(-3), '-3°C'],
		['formatTempC(null)', formatTempC(null), DASH],
		['formatBar(0)', formatBar(0), '0.0 bar'],
		['formatOdometer(0)', formatOdometer(0), '0 km'],
